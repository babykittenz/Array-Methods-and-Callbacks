...
console.log('Tanks 1b', finals2014[0]["Away Team Name"]);
//(c) Home Team goals for 2014 world cup final
console.log('Tanks 1c', finals2014[0]["Home Team Goals"]);
...
function getWinners(data, getscb) {
    /* code here */
    const finals = getscb(data);
...
function getWinnersByYear(data, getYearscb, getWinnerscb) {
    ...
    for(let i = 0; i < yearArray.length; i++){
        ...
        strArray.push("In " + yearArray[i] + ", " + countryArray[i] + " won the world cup!")
    }
